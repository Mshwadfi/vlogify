...
const Pricing = ()=> {
  return (
    <section id="pricing" className="py-12 lg:py-28 mx-auto px-6">
      <h2 className="text-2xl font-bold text-center uppercase mb-12 text-teal-500">
        Pricing
      </h2>
        ...
        {plans.map(({ id, name, price, description, items, paymentLink }) => (
          <div
            ...
            className={`lg:w-[25%] w-[60%] mx-auto lg:mx-0 p-8 border rounded-2xl ${
              id === "pro" ? "border-teal-500" : "border-gray-300"
            }`}
          >
            ...
            <Link href={paymentLink} className="flex items-center gap-2 text-teal-600 font-semibold">
